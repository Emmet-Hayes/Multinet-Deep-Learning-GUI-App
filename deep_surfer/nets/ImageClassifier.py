...
class ImageClassifier:
	...
	def create_model_graph(model_info, model_dir = 'deep_surfer/graphs'):
	...
	def maybe_download_and_extract(data_url, model_dir = 'deep_surfer/graphs'):
	...
	def prepare_file_system(summaries_dir = 'deep_surfer/tmp/retrain_logs', 
		intermediate_store_frequency = 0, 
		intermediate_output_graphs_dir = 'deep_surfer/tmp/intermediate_graph/'):
	...
	def create_model_info(architecture):
		...
		if architecture == 'inception_v3':
			...
			model_file_name = 'deep_surfer/graphs/inception_v3_2016_08_28_frozen.pb'
			input_mean = 128
			input_std = 128
	...
	def retrain_image_classifier(retrain_image_dir, has_retrain_parameters=False, 
		...
		output_graph = 'deep_surfer/tmp/output_graph.pb'
		intermediate_output_graphs_dir = 'deep_surfer/tmp/intermediate_graph/'
		intermediate_store_frequency = 0
		output_labels = 'deep_surfer/tmp/output_labels.txt'
		summaries_dir = 'deep_surfer/tmp/retrain_logs'
		...
		model_dir = 'deep_surfer/tmp/imagenet'
